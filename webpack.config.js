...
const alias = {
    ...
    '@': resolvePath('src'),
    Background: resolvePath('src/pages/Background'),
    Content: resolvePath('src/pages/Content'),
    'Options/*': resolvePath('src/pages/Options'),
    'Popup/*': resolvePath('src/pages/Popup'),
};
